                    ...
                    <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="assets/img/sam.jpg" class="img-circle" alt="User Image">
                                                </div>
                                                <h4>
                                                    Support Team
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Sam Pierce</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="experience.php">
                            <i class="fa fa-th"></i> <span>Experience</span>
                        </a>
                    </li>

                    <li>
                        <a href="education.php">
                            <i class="fa fa-th"></i> <span>Education</span>
                        </a>
                    </li>

                    <li>
                        <a href="interest.php">
                            <i class="fa fa-th"></i> <span>Interest</span>
                        </a>
                    </li>
                    <li>
                        <a href="awarts.php">
                            <i class="fa fa-th"></i> <span>Awarts</span>
                        </a>
                    </li>
